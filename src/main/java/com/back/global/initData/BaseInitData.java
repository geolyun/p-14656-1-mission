...
public class BaseInitData {
    ...
    private void work1() {
        ...
        if (postService.count() == 0){
            for (int i = 1; i <= 10; i++) {
                String title = "Sample Post " + i;
                String content = "content of sample post number " + i + ".";
    ...
    private void work2(){
        log.info("기존에 있던 Post 전체 조회");
        for (Post post : postService.findAll()) {
            log.debug("존재하는 Post: {}", post);
        }
    }
    ...
    private void work4(){
        ...
        for (Post post : postService.findAll()) {
            ...
            String newContent = post.getContent() + " content updated.";
    ...
    private void work5(){
        ...
        log.debug("삭제 후 남은 Post 갯수: {}", postService.count());
    }
}
